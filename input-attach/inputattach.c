...
static int magellan_init(int fd, __attribute__((unused)) unsigned long *id, __attribute__((unused)) unsigned long *extra)
{
...
static int warrior_init(int fd, __attribute__((unused)) unsigned long *id, __attribute__((unused)) unsigned long *extra)
{
...
static int spaceball_init(int fd, unsigned long *id, __attribute__((unused)) unsigned long *extra)
{
	char r[64];
...
static int stinger_init(int fd, __attribute__((unused)) unsigned long *id, __attribute__((unused)) unsigned long *extra)
{
	int i;
	unsigned char c;
...
static int mzp_init(int fd, __attribute__((unused)) unsigned long *id, __attribute__((unused)) unsigned long *extra)
{
...
static int newton_init(int fd, __attribute__((unused)) unsigned long *id, __attribute__((unused)) unsigned long *extra)
{
	unsigned int i;
	unsigned char c;
...
static int twiddler_init(int fd, __attribute__((unused)) unsigned long *id, __attribute__((unused)) unsigned long *extra)
{
	unsigned char c[10];
	int count, line;
...
static int fujitsu_init(int fd, __attribute__((unused)) unsigned long *id, __attribute__((unused)) unsigned long *extra)
{
...
static int t213_init(int fd, __attribute__((unused)) unsigned long *id, __attribute__((unused)) unsigned long *extra)
{
	char cmd[]={0x0a,1,'A'};
	int count=10;
	int state=0;
...
static int zhenhua_init(int fd, __attribute__((unused)) unsigned long *id, __attribute__((unused)) unsigned long *extra)
{
...
static int dump_init(int fd, __attribute__((unused)) unsigned long *id, __attribute__((unused)) unsigned long *extra)
{
	unsigned char c, o = 0;
